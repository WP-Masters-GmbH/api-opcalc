<x-front.layout title="{{ $title }}">
    <main class="mt-[68px] vr-styles">
        <section class="section pt-8 pb-8">
            <h1>Stocks with Highest dividend Yield</h1>
            <p>Find stocks with the highest dividend payouts, warning: just because a stock pays a dividend does not mean it’s free money</p>
                ...
                jQuery(document).ready(function ($) {
                    ...
                    var table = new Tabulator("#table-data", {
                        ...
                        initialSort:[             //set the initial sort order of the data
                            {column:"dividend_yield", dir:"desc"},
                        ],
                        columnDefaults:{
